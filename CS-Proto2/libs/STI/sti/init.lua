...
function Map:draw(tx, ty, sx, sy)
	...
	lg.push() -- commenting all these lines out makes it so it follows the camera's transformations, but introduces sprite tearing
  -- (FIXED) the sprite-tearing by changing the way the camera translates the drawn image (I rounded the coordinates on line 121 of camera.lua)
	--lg.origin() -- this
	lg.translate(math.floor(tx or 0), math.floor(ty or 0)) -- this
	...
	lg.push()
	lg.origin()
	lg.scale(sx or 1, sy or sx or 1) -- this
